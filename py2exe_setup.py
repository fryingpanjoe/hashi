...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "hashi.py"
 
        #Name of program
        self.project_name = "Hashi"
        ...
        #Auhor of program
        self.author_name = "Per Lindstrand"
        self.author_email = "p@codehut.se"
        self.copyright = "Copyright (c) 2009 CodeHut."
 
        #Description
        self.project_description = "Hashi: yet another japanese logic puzzle game"
